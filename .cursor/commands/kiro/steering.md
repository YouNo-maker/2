...
- Preopen plan: Check `.kiro/steering/preopen-news-driven-plan.md` via read_file; create if missing
...
The core steering files (product.md, tech.md, structure.md, preopen-news-driven-plan.md) are designed to be **Always Included** - loaded in every AI interaction to provide consistent project context.
...
- `preopen-news-driven-plan.md`: Always - Pre-market news-driven trading plan context required for related features
